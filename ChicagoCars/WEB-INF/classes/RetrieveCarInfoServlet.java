...
@WebServlet("/RetrieveCarInfoServlet")
public class RetrieveCarInfoServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        pw.println("<!doctype html><html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>CHICAGO CARS</title>");
		pw.println("<link rel='stylesheet' href='SearchResultPage_styles.css' type='text/css' /><script type='text/javascript' src='easySearch.js'></script></head><body onload='doCompletion()'><div id='container'><header><h1><a href='/'>CHICAGO <div>CARS</div></a></h1>");
		pw.println("</header><nav><ul><li class='start selected'><a href='Home.jsp'>Home</a></li><li class='start selected'><a href='LoginPage'>Login</a></li>");
        pw.println("<li class='start selected'><a href='ReadReview.jsp'>What Others Say About Our Service</a></li><li class='start selected'><a href='WriteReview.jsp'>Give Us Reviews</a></li><li class='start selected'><a href='Trending.jsp'>Trending</a></li><li class='start selected'><a onclick='return signOut();'>Logout</a></li></ul></nav>");
...
/*        Request.pZipCodes = new ArrayList<String>() {{
        ...
        */
        ...
        priceRange(pw);
        pw.println("</aside><div class='clear'></div></div><footer><div class='footer-content'><h5>Prices and offers are subject to change. © 2016 Best Deals. All rights reserved. BEST DEALS, the BEST DEAL logo, the tag design, MY BEST DEAL, and BESTDEALS.COM are trademarks of Best Deals and its affiliated companies.</h5>");
